...
model = tflearn.DNN(net, tensorboard_verbose=0,tensorboard_dir='log_gru16/',checkpoint_path='model_gru16/')
model.fit(train_data, train_label, n_epoch=1500,run_id='gru16',snapshot_epoch=True,validation_set=(test_data,test_label), show_metric=True, batch_size=20)
model.save("model_gru16/bitcoin_lstm.tfl")
